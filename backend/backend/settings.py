...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DJANGO_DB_USER", "django_user"),  # Changed the username to 'icb'
        "PASSWORD": os.getenv("DJANGO_DB_PASSWORD", "django_password"),  # Changed the password to 'icb'
